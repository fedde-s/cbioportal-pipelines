...
public class DatatypeMetadata {
	...
	// mod 15Apr2015 FJC use vep-based file name for mutations
	public static final String MUTATIONS_STAGING_FILENAME = "data_mutations_extended.txt";
	//public static final String MUTATIONS_STAGING_FILENAME = "data_mutations_vep.txt";
	public static final String MUTATIONS_STAGING_MISC_FILENAME = "data_mutations_misc.txt";
